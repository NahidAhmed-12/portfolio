...
import { useInView } from 'react-intersection-observer'; // ১. লাইব্রেরি ইম্পোর্ট করুন

function Hiro() {
    // ২. useInView হুক ব্যবহার করুন
    const { ref, inView } = useInView({
        triggerOnce: false, // প্রতিবার স্ক্রিনে আসলে অ্যানিমেশন আবার শুরু হবে
        threshold: 0.1,     // কম্পোনেন্টের ১০% দেখা গেলেই অ্যানিমেশন শুরু হবে
    });
                ...
                <div className='flex justify-center items-center md:items-start gap-12 md:justify-between flex-col-reverse md:flex-row w-full md:px-24'>
                    ...
                    <div className='flex-1'>
                        <div className='text-center md:text-start px-5 flex flex-col gap-3 md:gap-4' >
                            ...
                            {/* উন্নত এবং পারফরম্যান্ট টাইপিং অ্যানিমেশন */}
                            <div ref={ref} className="text-lg md:text-2xl lg:text-3xl font-[500] mt-2 max-w-xl h-16 md:h-auto">
                                {/* ৩. শুধুমাত্র inView === true হলেই TypeAnimation চলবে */}
                                {inView && (
                                    <TypeAnimation
                                        sequence={[
