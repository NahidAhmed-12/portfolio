...
function Navber() {
  ...
  // মেনু খোলা বা বন্ধ করার জন্য ফাংশন
  const toggleMenu = () => {
    setIsMenuOpen(!isMenuOpen);
  };
  
  // একটি লিঙ্কে ক্লিক করলে মেনু বন্ধ করার জন্য ফাংশন
  ...
  useEffect(() => {
    ...
    // কম্পোনেন্ট আনমাউন্ট হলে স্টাইল রিসেট করার জন্য
    return () => {
      document.body.style.overflow = 'auto';
    };
  }, [isMenuOpen]);
  ...
  return (
    <>
      {/* মূল নেভিগেশন বার */}
      <nav className="fixed top-0 left-0 right-0 z-[100] bg-gray-900/70 backdrop-blur-lg border-b border-gray-500/20">
      ...
      <div
        className={`fixed inset-0 z-[99] w-full h-screen bg-gray-900/95 backdrop-blur-sm transition-opacity duration-300 ease-in-out md:hidden
        ...
        <div className="flex flex-col items-center justify-center h-full gap-y-4">
          {navItems.map((item, index) => (
            <NavLink
              ...
              // Cascade অ্যানিমেশনের জন্য ডিলে (delay) যোগ করা হয়েছে
