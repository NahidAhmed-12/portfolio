...
function Workflow() {
    ...
    return (
        <section className="py-16 md:py-24 px-5 md:px-24 bg-neutral-950" id="workflow">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
                {steps.map((step, index) => (
                    <div key={step.id} className="relative group">
                        ...
                        {/* কানেক্টিং লাইন (শুধু বড় স্ক্রিনে এবং শেষ আইটেম বাদে) */}
                        ...
                        {/* কার্ড বডি */}
                        <div className="bg-neutral-900/50 border border-neutral-800 p-6 rounded-2xl h-full
                                        transform transition-all duration-300 ease-in-out
                                        hover:-translate-y-2 hover:border-cyan-500/50 hover:shadow-lg hover:shadow-cyan-500/20">
                            
                            {/* আইকন এবং নম্বর */}
                            <div className="flex justify-between items-start mb-6">
                                <div className="h-14 w-14 rounded-full bg-neutral-800 border border-neutral-700 flex items-center justify-center text-2xl text-cyan-500 shadow-lg group-hover:scale-110 transition-transform duration-300 group-hover:bg-cyan-500/10 group-hover:border-cyan-500">
